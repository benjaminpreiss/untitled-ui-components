<script lang="ts">
	...
	const stylePaddings = {
		sm: {
			padding: 'px-[0.5rem] py-[0.125rem] gap-1.5 '
		},
		md: {
			padding: ' px-[0.625rem] py-[0.125rem] gap-2'
		},
		lg: {
...
<button
    ...
    {onClick
		? 'pointer-events-auto'
		: 'pointer-events-auto cursor-default'} flex justify-center items-center focus-visible:outline-none focus:outline-none"
>
	<slot name="icon-left" />
	<slot />
